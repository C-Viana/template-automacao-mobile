...
//			Thread.sleep((timeInSeconds == null) ? StaticResources.DEFAULT_WAIT_TIME : timeInSeconds * 1000);
	...
	public static double compareImages(String currentImagePath, String expectedImageSource,
			double differenceToleration) {
		try {
			BufferedImage img1 = ImageIO.read(new File(currentImagePath));
			BufferedImage img2 = ImageIO.read(new File(expectedImageSource));
